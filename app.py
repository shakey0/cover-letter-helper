...
@app.route('/delete_input/<string:slug>', methods=['GET', 'POST'])
...
@app.route('/delete_variables/<string:slug>', methods=['GET', 'POST'])
...
@app.route('/delete_paragraph/<string:slug>', methods=['GET', 'POST'])
